...
- **~290 POI** собрано через Google Places API (New) по 8 городам Азербайджана
- **106** ветклиник / **165** зоомагазинов / **21** груминг-салон / **1** приют / **18** B2B-точек (yem dükanı, базары)
...
_Research snapshot: 2026-04-29_
